...
const visitedCountriesData: Record<string, CountryData> = {
  ...
  "724": { id: "724", name: "España", flagCode: "es", review: "Ciudades, islas y costas recorridas entre historia, arquitectura y distintas formas de vida mediterránea.", image: "/assets/españa.HEIC" },
  ...
  "076": { id: "076", name: "Brasil", flagCode: "br", image: "/assets/brasil.HEIC" },
