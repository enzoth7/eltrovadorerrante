...
const visitedCountriesData: Record<string, CountryData> = {
  "858": { id: "858", name: "Uruguay", flagCode: "uy", review: "La raíz y el punto de regreso. El ritmo del litoral, la cercanía del río y una identidad construida lejos del ruido de las grandes capitales.", image: VSCO_IMAGES.coast },
  "372": { id: "372", name: "Irlanda", flagCode: "ie", review: "La primera vida larga en el exterior: otro idioma, otra escala de ciudad y el aprendizaje cotidiano de empezar desde cero.", image: VSCO_IMAGES.coast },
  "250": { id: "250", name: "Francia", flagCode: "fr", review: "La síntesis mediterránea: mar, historia, arquitectura, caminatas y una forma más luminosa de habitar la ciudad.", image: VSCO_IMAGES.night },
  "724": { id: "724", name: "España", flagCode: "es", review: "Ciudades, islas y costas recorridas entre historia, arquitectura y distintas formas de vida mediterránea." },
  "826": { id: "826", name: "Reino Unido", flagCode: "gb" },
  "380": { id: "380", name: "Italia", flagCode: "it" },
  "032": { id: "032", name: "Argentina", flagCode: "ar" },
  "756": { id: "756", name: "Suiza", flagCode: "ch" },
  "076": { id: "076", name: "Brasil", flagCode: "br" },
  "492": { id: "492", name: "Mónaco", flagCode: "mc", review: "Un territorio mínimo y vertical, comprimido entre la roca, el Mediterráneo y una arquitectura de otra escala." },
  "336": { id: "336", name: "Ciudad del Vaticano", flagCode: "va" },
};
