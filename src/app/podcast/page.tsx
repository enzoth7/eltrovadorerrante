...
export default function PodcastPage() {
  return (
    <div className="bg-white">
      <section className="grid min-h-[calc(100svh-5rem)] bg-blue text-white lg:grid-cols-[1.05fr_.95fr]">
        ...
        <div className="relative min-h-[60svh] overflow-hidden border-t border-white/25 lg:min-h-full lg:border-l lg:border-t-0">
          <Image src={VSCO_IMAGES.wineShop} alt="Un café mediterráneo en Niza" fill priority sizes="(max-width: 1024px) 100vw, 48vw" className="museum-image object-cover opacity-85" />
